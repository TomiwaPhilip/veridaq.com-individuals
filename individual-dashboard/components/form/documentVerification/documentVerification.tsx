...
import { createDocumentVerificationRequest, createDocumentVerificationRequestForAdmin } from "@/lib/actions/request.action"
import { DocumentVerificationValidation, DocumentVerificationValidation2 } from '@/lib/validations/documentverification';
...
const DocumentVerification: React.FC = () => {
  ...
  const onSubmit2 = async (data: z.infer<typeof DocumentVerificationValidation2>) => {
    console.log("I want to submit")
    try {
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                ...
                                <SelectItem value="EOT">Evidence of Transaction</SelectItem>
